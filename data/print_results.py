...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("Used CNN model architecture :", model)  
    ...
    print("Percentage Correct Dogs: ", results_stats_dic['pct_correct_dogs'])
    print("Percentage Correct Breeds: ", results_stats_dic['pct_correct_breed'])
    print('Percentage "Not-a" Dogs: ', results_stats_dic['pct_correct_notdogs'])
